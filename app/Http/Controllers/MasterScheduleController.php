...
class MasterScheduleController extends Controller
{
   ...
   /* public function data(Request $request)
    ...
    public function createMasterSchedule(Request $request)
{
    ...
    // Log the activity (you can store it in the database, for example)
    // Here we're just returning a success message for demonstration
